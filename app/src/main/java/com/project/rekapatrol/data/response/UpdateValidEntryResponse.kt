...
data class UpdateValidEntryResponse(

	@field:SerializedName("data")
	val data: DataValidEntry? = null
)

data class FindingsItemValidEntry(
...
data class DataValidEntry(
	...
	val findings: List<FindingsItemValidEntry?>? = null,

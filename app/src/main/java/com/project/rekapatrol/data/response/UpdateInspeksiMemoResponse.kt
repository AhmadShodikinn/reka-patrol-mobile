...
data class UpdateInspeksiMemoResponse(

	@field:SerializedName("data")
	val data: DataUpdateInspection? = null
)

data class MemoUpdateInspection(
...
data class DataUpdateInspection(
	...
	val memo: MemoUpdateInspection? = null,
